...
#define AI_NETWORK_IN_1_SIZE  (160 * 160 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((160 * 160 * 1) * 4)
...
#define AI_NETWORK_OUT_1_SIZE  (5 * 5 * 30)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((5 * 5 * 30) * 4)
